				...
				<VanillaTweaksTable
					...
					rows={[
						...
						[
							"wood stripper",
							"v1.0.0",
							"Adds stonecutter recipes for stripping logs and bark",
							"This adds a lot of convenience for building with wood and crafting hanging signs",
						],
					]}
				/>
				<VanillaTweaksTable
